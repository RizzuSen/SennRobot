...
buttons = [
    ...
    [
        InlineKeyboardButton(text="ᴀʙᴏᴜᴛ", callback_data="Kyy_"),
    ...
    [
        InlineKeyboardButton(
            text="sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ​", url="https://github.com/muhammadrizky16/KyyRobot"
        ),
        InlineKeyboardButton(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    ...
                    InlineKeyboardButton(text="ɴᴏᴛᴇs​", callback_data="Kyy_notes"),
                 ],
                 [
                    InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ​", callback_data="Kyy_support"),
                 ...
                 [
                    InlineKeyboardButton(text="ɢᴏ ʙᴀᴄᴋ​", callback_data="Kyy_back"),
                 ]
                ]
            ),
        )
...
**Telegram Library:** `v{peler}`""",
    ...
    if WEBHOOK:
        ...
        updater.start_polling(gallowed_updates=Update.ALL_TYPES, timeout=15, read_latency=4, drop_pending_updates=True)
